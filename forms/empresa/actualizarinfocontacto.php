...
<div class="container">
 ...
 <div class="row form">
  <div class="info">
     ...
     <form method="POST"  name="actualizarInfoContacto" action="../empresa/redirect.php" id="registrar">

            <p>
            <label for="nombreContacto">Persona de Contacto:</label>
            </p>
            <p>
            <input type="text" name="nombreContacto" placeholder="Primer Nombre" value="<?php echo $nombreContacto; ?>">
            <span class="requerido">*</span>

            </p>

            <p>
            <input type="text" name="apellidoContacto" placeholder="Primer Apellido" value="<?php echo $apellidoContacto; ?>">
            <span class="requerido">*</span>
            ...
            <p>
            <input type="email" name="correo" placeholder="tunombre@tuempresa.com">
            <span class="requerido">*</span>
            </p>
            ...
            <p>
            <input type="url" name="paginaWeb" placeholder="http://www.tuempresa.com">
            </p>
            ...
            <p>
            <input type="text" name="telefono" placeholder="12345678">
            <span class="requerido">*</span>
            ...
            <p>
            <input type="text" name="fax" placeholder="12345678">
            </p>

            <p>
            <input type="submit" value="Guardar" name="actualizarInfoContacto">
            </p>       
