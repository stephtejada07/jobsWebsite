...
<title>Regristro</title>
  ...
  <script type="text/javascript" src="../../js/empresa/validarinfoempresa1.js"></script>
...
<div class="container">
 ...
 <div class="row formm">
  <div class="info">
    ...
    <form method="post" name="actualizarInfoEmpresa" action="../empresa/redirect.php" id="registrar">
            ...
            <p>
            <select name="area">
            <option value="<?php echo $oEmpresa->getIdArea($area); ?>"><?php echo $area; ?></option>
            <?php 
                $oEmpresa->getArea();
            ?>
            </select>
            ...
            <p>
            <input type="submit" value="Continuar" name="actualizarInfoEmpresa">
            </p>
