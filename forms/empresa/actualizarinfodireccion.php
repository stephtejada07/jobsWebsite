...
<title>Registro</title>
  ...
  <script type="text/javascript" src="../../js/aspirante/validarinfodireccion1.js"></script>
...
<div class="container">
 ...
 <div class="row formm">
  <div class="info">
    ...
    <form method="POST" name="actualizarInfoDireccion" action="../empresa/redirect.php" id="registrar">
            ...
            <p>
            <input type="text" name="direccion1" placeholder="Residencial/Colonia/Complejo/Zona" value="<?php echo $direccion1; ?>">
            </p>
            ...
            <p>
            <input type="text" name="direccion2" placeholder="Senda/Pasaje/Calle/Avenida, Número de Casa/Apartamento" value="<?php echo $direccion2; ?>">
            </p>
            ...
            <p>
            <input type="text" name="ciudad" placeholder="Ciudad/Metrópoli/Población/Localidad/Pueblo" value="<?php echo $ciudad; ?>">
            ...
            <select name="departamento">
                <option value="<?php echo $oPaises->getIdDepartamento($departamento) ?>"><?php echo $departamento; ?>
                </option>
                <?php 
                $oPaises->getDepartamentos();
                ?>
            </select>
            <span class="requerido">*</span>
            </p>
            ...
            <p>
            <input type="text" name="pais" placeholder="El Salvador" value="El Salvador" readonly>
            </p>
            <span class="requerido">*</span>
            </p>

            <p>
            <input type="submit" value="Guardar" name="actualizarInfoDireccion">
            </p> 
