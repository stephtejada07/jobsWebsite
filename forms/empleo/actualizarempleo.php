...
<div class="container">
 ...
 <div class="row formm">
  <div class="info">
     ...
     <form method="POST"  name="actualizarEmpleo" action="../empleo/redirect.php" id="registrar">

            <p>
            <label for="titulo">Título:</label>
            </p>
            <p>
            <input type="text" name="titulo" placeholder="Título del empleo" value="<?php echo $titulo; ?>">
            ...
            <p>
            <input type="number" name="presupuesto" min="0" value="<?php echo $presupuesto; ?>">
            </p>
            ...
            <select name="horasPorSemana" id="">
              <option value="<?php echo $oEmpleo->getIdHorasPorSemana($horasSemana); ?>"><?php echo $horasSemana; ?></option>
              <?php 
            ...
            <select name="tipoTrabajo" id="">
              <option value="<?php echo $oEmpleo->getIdTipoTrabajo($tipoTrabajo); ?>"><?php echo $tipoTrabajo; ?></option>
              <?php 
            ...
            <select name="categoria" id="">
              <option value="<?php $oEmpleo->getIdCategorita($categoria); ?>"><?php echo $categoria; ?></option>
              <?php 
            ...
            <p>
            <input type="submit" value="Actualizar" name="actualizarEmpleo">
            </p>       
