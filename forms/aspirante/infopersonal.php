    ...
    if ($db) {
      ...
      $sqlSelect = 'SELECT
        ...
        foreach ($stmnt as $row) {
          $nacimiento = $row['nacimiento'] != '' ? $row['nacimiento'] : '-';
          $documento = $row['documento'] != '' ? $row['documento'] : '-';
          $estadoCivil = $row['estadoCivil'] != 'NULL' ? $row['estadoCivil'] : '';
          $genero =  $row['genero'] != 'NULL' ? $row['genero'] : '';
          }
    }
    else {
      $nacimiento = '-';
...
<div class="container">
 ...
 <div class="row formm">
  <div class="info">
    ...
    <form method="post" name="actualizarinfopersonal" action="actualizarinfopersonal.php" id="registrar">

            <p>
            <label for="nacimiento">Nacimiento:</label>
            <span class="perfil"><?php echo $nacimiento; ?></span>
            </p>
            ...
            <span class="perfil"><?php echo $estadoCivil; ?></span>
            </p>
            
            <p>
            <label for="genero">Género:</label>
            <span class="perfil"><?php echo $genero; ?></span>
            </p>

            <p>
            <input type="submit" value="Actualizar" name="actualizarinfopersonal">
            </p>
