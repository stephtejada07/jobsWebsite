    ...
    try {
      ...
      if ($db) {
        ...
        if ($numero_filas != 0) {
          ...
          // 
          $resultCount = $stmnt->execute($valores);
        ...
        $celular =  $row['celular'] != 'NULL' ? $row['celular'] : '';
   ...
   <div class="row form">
    <div class="info">
     ...
     <a href="../aspirante/infocontacto.php">| CONTACTO </a>
       ...
       <form method="POST"  name="actualizarinfocontacto" action="redirect.php" id="registrar">
              <p>
              <label for="correo">Email:</label>
              </p>
              <p>
              <input type="email" name="correo" placeholder="tunombre@ejemplo.com" value="<?php echo $correo; ?>">
              ...
              <p>
              <input type="url" name="paginaWeb" placeholder="http://www.tupagina.com" value="<?php echo $paginaWeb; ?>">
              </p>
              ...
              <p>
              <input type="text" name="telefono" placeholder="12345678" value="<?php echo $telefono; ?>">
              </p>
              ...
              <p>
              <input type="text" name="celular" placeholder="12345678" value="<?php echo $celular; ?>">
              <span class="requerido">*</span>
              </p>
              ...
              <p>
              <input type="text" name="fax" placeholder="12345678" value="<?php echo $fax; ?>">
              </p>
