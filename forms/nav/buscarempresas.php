...
<div class="row form">
  <div class="info">
	...
	<form method="post" action="../nav/listaempresas.php">
  		<h2>EMPRESAS POR ÁREA:</h2>
  		<select name="area">
  			<option value="">Selecciona una opción</option>
                  <?php $oEmpresa->getArea(); ?>
  		</select>
  		<input type="submit" value="Buscar" name="buscarArea">
  		<h2>EMPRESAS POR DEPARTAMENTO:</h2>
  		<select name="departamento">
  			<option value="">Selecciona una opción</option>
                  <?php  $oPaises->getDepartamentos(); ?>
  		</select>
  		<input type="submit" value="Buscar" name="buscarDepartamento">
