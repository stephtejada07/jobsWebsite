...
<?php 
//  Load information for category dropdown 
require_once '../../class/class.Empleo.inc';
$oEmpleo = new Empleo();
require_once '../../class/class.Paises.inc';
$oPaises = new Paises();
?>
...
<div class="row form">
  <div class="info">
	...
	<form method="post" action="../nav/listaempleos.php">

  		<h2>EMPLEOS POR CATEGORÍA:</h2>
  		<select name="categoria">
  			<option value="">Selecciona una opción</option>
                  <?php $oEmpleo->getCategorias(); ?>
  		</select>
  		<input type="submit" value="Buscar" name="buscarCategoria">
  		
            <h2>EMPLEOS POR HORAS:</h2>
            <select name="hora">
                  <option value="">Selecciona una opción</option>
                  <?php $oEmpleo->getHorasPorSemana(); ?>
            </select>
            <input type="submit" value="Buscar" name="buscarHora">
