...
<div class="container">
 ...
 <div class="row form">
  <div class="info">
     <h2>CONTÁCTANOS</h2>
     <span class="infoo">Envía tus comentarios. </span>
     </div>

     <form method="POST" action="redirect.php" id="comentario" >
     	<p>
	...
	<span class="requerido">*</span>
     	...
     	<p>
     	<input type="email" name="email" placeholder="tunombre@ejemplo.com">
	<span class="requerido">*</span>
     	</p>
	...
	<span class="requerido">*</span>
     	...
     	<p><input type="submit" value="Enviar" name="enviarComentario" id="registrar"></p>
     </form>
